...
namespace versioning_manager_api.DevDatabase
{
    ...
    public class DbUser
    {
        ...
        [Column("username")] [MaxLength(FieldsLimits.MaxUsernameLength)]public required string Username { get; set; }
        [Column("password")] [MaxLength(FieldsLimits.MaxPasswordLength + 100)][MinLength(FieldsLimits.MinPasswordLength)]public required string Password { get; set; }
    ...
    {
        [Key] [Column("id")] [DatabaseGenerated(DatabaseGeneratedOption.Identity)] public int Id { get; set; }
        [Column("name")] [MaxLength(FieldsLimits.MaxRoleName)]public required string Name { get; set; }
    ...
    public class DbProject
    {
        ...
        public required DbUser Creator { get; set; }
        [Column("creator_user_id")]
        public int CreatorId { get; set; }
        
        [Column("available_sources")]
        public required string[] AvailableSources { get; set; }
        [Column("creation_utc")]
        public DateTimeOffset CreationUTC { get; set; } = DateTimeOffset.UtcNow;
    ...
    public class DbProjectEntry
    {
        ...
        public required DbProject Project { get; set; }
        [Column("project")]
    ...
    public class DbImageInfo
    {
        ...
        [Column("docker_compose_file")]
        public required string DockerCompose { get; set; }
        
        [ForeignKey(nameof(ProjectId))]
        public required DbProjectEntry Project { get; set; }
        [Column("project_entry")]
        public int ProjectId { get; set; }
        
        [ForeignKey(nameof(CreatorId))]
        public required DbDevice Creator { get; set; }
