...
/// </summary>
public class ProjectEntryInfoResponse(int id, string projectName, string version, bool isActual, DateTimeOffset lastUpdatedUtc, int? imageCount)
{
    /// <summary>
    ...
    /// <summary>
    /// Creates an instance of <see cref="ProjectInfoResponse"/> from <paramref name="projectName"/> and <see cref="DbProjectEntry"/>.
    /// </summary>
    ...
    {
        return new ProjectEntryInfoResponse(entry.Id, projectName, entry.Version, entry.IsActual, entry.LastUpdateUTC, entry.Images?.Count);
    }
}